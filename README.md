...
<p align="center"> <img src="docs/demo/home-page.png" alt="Webserv demonstration website served by the C++98 HTTP server" width="1000" > </p>

<p align="center"> <em> A complete demonstration website served directly by the custom C++98 HTTP server. </em> </p>
...
<p align="center"> <a href="docs/demo/server-build.png"> <img src="docs/demo/server-build.png" alt="Webserv compilation output" width="900" > </a> </p>

<p align="center"> <em> Clean build output showing the selected compile-time logger level. </em> </p>
...
<p align="center"> <a href="docs/demo/server-start.png"> <img src="docs/demo/server-start.png" alt="Webserv startup with the demonstration configuration" width="900" > </a> </p>

<p align="center"> <em> Webserv starting its configured listeners and entering the non-blocking event loop. </em> </p>
...
```sh
make LOG_LEVEL=1   # errors only, default
make LOG_LEVEL=2   # errors and informational messages
make LOG_LEVEL=3   # errors, information, and debug traces
```
...
<p align="center">
  <a href="docs/demo/features.png">
    <img
      src="docs/demo/features.png"
      alt="Overview of Webserv demonstration features"
      width="1000"
    >
  </a>
</p>
...
<p align="center">
  <em>
    The demonstration website provides direct access to the main HTTP server features.
  </em>
</p>
...
<table>
  <tr>
    <td width="50%" align="center">
      <a href="docs/demo/autoindex.png">
        <img
          src="docs/demo/autoindex.png"
          alt="Directory autoindex generated by Webserv"
        >
      </a>
      <br>
      <strong>Directory autoindex</strong>
      <br>
      <sub>
        A directory listing dynamically generated by the server.
      </sub>
    </td>
    <td width="50%" align="center">
      <a href="docs/demo/autoindex-of-public.png">
        <img
          src="docs/demo/autoindex-of-public.png"
          alt="Public directory autoindex generated by Webserv"
        >
      </a>
      <br>
      ...
      <br>
      <sub>
        Static resources exposed through a configuration-driven route.
      </sub>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%" align="center">
      <a href="docs/demo/file-upload.png">
        <img
          src="docs/demo/file-upload.png"
          alt="Browser multipart file upload through Webserv"
        >
      </a>
      <br>
      ...
      <br>
      <sub>
        A multipart form submitted through an HTTP POST request.
      </sub>
    </td>
    <td width="50%" align="center">
      <a href="docs/demo/file-uploaded.png">
        <img
          src="docs/demo/file-uploaded.png"
          alt="File successfully uploaded through Webserv"
        >
      </a>
      <br>
      ...
      <br>
      <sub>
        The uploaded file appears immediately in the configured storage directory.
      </sub>
    </td>
  </tr>
</table>

#### Dynamic Content and Sessions

<table>
  <tr>
    <td width="50%" align="center">
      <a href="docs/demo/cgi.png">
        <img
          src="docs/demo/cgi.png"
          alt="CGI script executed by Webserv"
        >
      </a>
      <br>
      <strong>CGI execution</strong>
      <br>
      <sub>
        A CGI script receives request metadata and generates a dynamic HTTP response.
      </sub>
    </td>
    <td width="50%" align="center">
      <a href="docs/demo/cookie-session.png">
        <img
          src="docs/demo/cookie-session.png"
          alt="Cookie and server-side session demonstration"
        >
      </a>
      <br>
      <strong>Cookies and sessions</strong>
      <br>
      <sub>
        Session creation, visit counting, cookie handling, and logout.
      </sub>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%" align="center">
      <a href="docs/demo/custom-error-404.png">
        <img
          src="docs/demo/custom-error-404.png"
          alt="Custom 404 error page served by Webserv"
        >
      </a>
      <br>
      ...
      <br>
      <sub>
        A configuration-defined response for a missing resource.
      </sub>
    </td>
    <td width="50%" align="center">
      <a href="docs/demo/custom-error-504.png">
        <img
          src="docs/demo/custom-error-504.png"
          alt="Custom 504 CGI timeout page served by Webserv"
        >
      </a>
      <br>
      <strong>Custom 504 page</strong>
      <br>
      <sub>
        A timed-out CGI process is terminated without blocking the server.
      </sub>
    </td>
  </tr>
</table>
